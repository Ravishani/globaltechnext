        ...
        <div className="mx-auto w-full max-w-[1480px] px-5 sm:px-7 lg:px-10">
          <div className="grid min-h-[850px] items-center gap-14 py-10 sm:py-24 lg:grid-cols-[0.88fr_1.12fr] lg:gap-20 lg:py-20">
            <div className="relative z-10">
              ...
              <h1 className="max-w-[820px] text-[35px] font-[900] leading-[42px] tracking-[-0.5px] sm:text-[48px] sm:leading-[55px] sm:tracking-[-1px] lg:text-[60px] lg:leading-[65px] lg:tracking-[-0.5px]">
                Let's build
        ...
        <div className="mx-auto max-w-[1480px] px-5 sm:px-7 lg:px-10">
          <div className="grid gap-10 md:grid-cols-[0.7fr_1.3fr] md:items-center">
            <div>
              ...
              <h2 className="mt-6 max-w-[700px] text-[35px] font-[900] leading-[42px] tracking-[-0.5px] text-white sm:text-[48px] sm:leading-[55px] sm:tracking-[-1px] lg:text-[60px] lg:leading-[65px] lg:tracking-[-0.5px]">
                Simple process.
        ...
        <div className="mx-auto max-w-[1150px] px-5 sm:px-7 lg:px-10">
          <div className="relative overflow-hidden rounded-[30px] bg-[#090909] px-6 py-12 text-center sm:px-12 sm:py-16">
            ...
            <div className="relative">
              ...
              <h2 className="mx-auto mt-6 max-w-[800px] text-[35px] font-[900] leading-[42px] tracking-[-0.5px] text-white sm:text-[48px] sm:leading-[55px] sm:tracking-[-1px] lg:text-[60px] lg:leading-[65px] lg:tracking-[-0.5px]">
                Your next big idea
