    ...
    >
      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            ...
            className={`relative z-[90] flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#DDD6CA] bg-[#F7F4EE] text-[#25231F] transition-all duration-300 hover:border-[#C8AE72] hover:bg-[#1B1A17] hover:text-[#FF7200] sm:h-11 sm:w-11 xl:hidden ${
      ...
      >
        ...
        <aside
          ...
          aria-hidden={!mobileOpen}
          className={`absolute right-0 top-[22px] h-[100dvh] w-[min(390px,88vw)] max-w-full overflow-hidden border-l border-[#DED6C8] bg-[#FDFCF9] shadow-[-25px_0_80px_rgba(25,22,18,0.22)] transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
            mobileOpen
              ? "translate-x-0"
              : "translate-x-full"
          }`}
