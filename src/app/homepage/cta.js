...
export default function CTA() {
  return (
    <section className="relative w-full overflow-hidden bg-white pt-10 pb-5 sm:pt-16 sm:pb-8 lg:pt-20 lg:pb-8">
        ...
        <div className="relative">
          <div className="grid items-center gap-10 sm:gap-12 lg:grid-cols-[minmax(0,1fr)_280px] lg:gap-16 xl:grid-cols-[minmax(0,1fr)_320px] xl:gap-24">
            <div className="relative pl-5 sm:pl-7 lg:pl-9">
              ...
              <div className="mb-5 flex items-center gap-3 sm:mb-6">
                <span className="text-[9px] font-bold uppercase tracking-[2px] text-[#FF6500] sm:text-[10px] sm:tracking-[2.5px]">
                  Let's Build Something Great
                </span>
              </div>

              <h2 className=" text-[28px] font-[900] leading-[42px] tracking-[-0.5px] text-black sm:text-[48px] sm:leading-[55px] sm:tracking-[-1px] lg:text-[60px] lg:leading-[65px] lg:tracking-[-0.5px]">
                Ready to turn
                <span className="block">your vision into</span>
              ...
              <p className="mt-5 max-w-[590px] text-[13px] leading-[1.8] tracking-[0.05px] text-[#77716F] sm:mt-6 sm:text-[14px] sm:leading-[1.75] lg:text-[14px]">
            ...
            <div className="relative lg:pb-1">
              <div className="mb-5 max-w-[280px] text-[12px] leading-[1.7] tracking-[0.05px] text-[#96908A] lg:mb-6">
              ...
              >
                <span className="text-[9px] font-bold uppercase tracking-[1.5px] sm:text-[10px]">
                  Start Your Project
                </span>
              ...
              <Link
                href="/portfolio"
                className="group mt-4 flex items-center gap-2 text-[9px] font-bold uppercase tracking-[1.4px] text-[#77716F] transition-colors duration-300 hover:text-[#FF6500]"
              >
                Explore Our Work
          ...
          <div className="mt-12 flex flex-col border-t border-[#111111]/[0.07] pt-5 sm:mt-14 sm:pt-6 lg:mt-16 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex flex-wrap items-center gap-x-4 gap-y-3 sm:gap-x-7">
              <span className="text-[9px] font-bold uppercase tracking-[1.1px] text-[#8F8982]">
                Strategy
              </span>
            ...
            <div className="mt-4 flex items-center gap-2 lg:mt-0">
              ...
              <span className="text-[9px] font-bold uppercase tracking-[1.5px] text-[#77716F]">
                GlobalTechNext
              </span>
            </div>
          </div>
