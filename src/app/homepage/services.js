    ...
    <section className="relative isolate w-full overflow-hidden bg-[#070707] py-10 sm:py-24 lg:py-20">
      ...
      <div className="mx-auto w-full max-w-[1480px] px-5 sm:px-7 lg:px-10">
        <div className="mx-auto max-w-[850px] text-center">
          ...
          <h2 className=" text-[28px] font-[900] leading-[42px] tracking-[-0.5px] text-white sm:text-[48px] sm:leading-[55px] sm:tracking-[-1px] lg:text-[60px] lg:leading-[65px] lg:tracking-[-0.5px]">
            We Build Digital
