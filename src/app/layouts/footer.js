    ...
    <div className="relative flex items-center gap-3 overflow-hidden rounded-full border border-white/[0.10] bg-[#101010]/95 py-2 pl-2 pr-3 shadow-[0_12px_45px_rgba(0,0,0,0.35)] backdrop-blur-xl transition-all duration-500 group-hover:border-[#25D366]/30 group-hover:bg-[#151515] group-hover:shadow-[0_15px_50px_rgba(37,211,102,0.12)]">
      ...
      <footer className="relative w-full overflow-hidden bg-[#080808] text-white">
        ...
        <div className="mx-auto w-full max-w-[1480px] px-5 sm:px-7 lg:px-10">
          <div className="border-b border-white/[0.08] py-9 sm:py-10 lg:py-12">
            <div className="grid items-center gap-6 lg:grid-cols-[1fr_auto] lg:gap-10">
              <div>
                <div className="flex items-center gap-3">
                  <span className="h-[2px] w-8 rounded-full bg-[#FF6500]" />

                  <span className="text-[8px] font-bold uppercase tracking-[2.4px] text-[#FF7900]">
                    Let's Work Together
                  </span>
                </div>

                <h2 className="mt-3.5 text-[30px] font-[900] leading-[33px] tracking-[-1.4px] text-white sm:text-[38px] sm:leading-[40px] lg:text-[46px] lg:leading-[48px]">
                ...
                <p className="mt-3 max-w-[510px] text-[10px] leading-[18px] text-[#706B65] sm:text-[11px] sm:leading-[19px]">
              ...
              <Link
                href="/contact"
                className="group flex h-[52px] w-full items-center justify-between rounded-full bg-white px-5 text-[8px] font-bold uppercase tracking-[1.3px] text-[#111111] transition-all duration-300 hover:-translate-y-1 hover:bg-[#FF6500] hover:text-white hover:shadow-[0_12px_35px_rgba(255,90,0,0.18)] sm:w-[205px]"
              >
          ...
          <div className="grid gap-9 py-9 sm:grid-cols-2 lg:grid-cols-[1.35fr_0.65fr_0.95fr_1fr] lg:gap-10 lg:py-10">
            <div>
              <Link href="/" className="inline-flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-[11px] bg-gradient-to-br from-[#FF4D00] to-[#FF9800] shadow-[0_8px_25px_rgba(255,90,0,0.15)]">
                  <span className="text-[16px] font-[900] text-white">G</span>
                </span>

                <span>
                  <span className="block text-[16px] font-[900] tracking-[-0.5px] text-white">
                    GlobalTechNext
                  </span>

                  <span className="mt-0.5 block text-[7px] font-bold uppercase tracking-[1.8px] text-[#514C47]">
                    Digital Innovation
                  </span>
                </span>
              </Link>

              <p className="mt-4 max-w-[350px] text-[11px] leading-[19px] text-[#77716A]">
                GlobalTechNext helps businesses transform ideas into powerful
                digital experiences through technology, creative design and
                strategic thinking.
              </p>

              <p className="mt-3 max-w-[350px] text-[10px] leading-[17px] text-[#59544E]">
              ...
              <div className="mt-5 flex gap-2">
                <SocialIcon
                  href="#"
                  label="LinkedIn"
                  icon={<IconBrandLinkedin size={14} stroke={1.5} />}
                />

                <SocialIcon
                  href="#"
                  label="Instagram"
                  icon={<IconBrandInstagram size={14} stroke={1.5} />}
                />

                <SocialIcon
                  href="#"
                  label="Facebook"
                  icon={<IconBrandFacebook size={14} stroke={1.5} />}
                />

                <SocialIcon
                  href="#"
                  label="X"
                  icon={<IconBrandX size={13} stroke={1.5} />}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Link
                href="/services"
                className="group mt-5 inline-flex items-center gap-2 text-[9px] font-bold uppercase tracking-[1px] text-[#FF7900]"
              >
                View All Services
            ...
            <div>
              ...
              <p className="mt-5 text-[10px] leading-[17px] text-[#77716A]">
              ...
              <form
                ...
                className="mt-4 flex h-[46px] w-full items-center rounded-full border border-white/[0.1] bg-white/[0.035] p-1 transition-all duration-300 focus-within:border-[#FF6500]/40 focus-within:bg-white/[0.05]"
              >
                <IconMail
                  size={14}
                  stroke={1.5}
                ...
                <input
                  ...
                  required
                  className="h-[38px] min-w-0 flex-1 bg-transparent px-2.5 text-[10px] text-white outline-none placeholder:text-[#5E5852]"
                />

                <button
                  type="submit"
                  aria-label="Subscribe"
                  className="group flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-full bg-[#FF6500] text-white transition-all duration-300 hover:bg-[#FF7900]"
                >
                  <IconArrowUpRight
                    size={14}
                    stroke={1.8}
              ...
              <div className="mt-5 space-y-2.5">
                <a
                  ...
                  className="group flex items-center gap-2 text-[10px] text-[#77716A] transition-colors hover:text-white sm:text-[11px]"
                >
                  <IconMail
                    size={13}
                    stroke={1.5}
          ...
          <div className="border-t border-white/[0.08] py-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-[10px] font-medium text-[#625C56] sm:text-[11px]">
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                <Link
                  href="/privacy-policy"
                  className="text-[10px] text-[#625C56] transition-colors hover:text-white sm:text-[11px]"
                >
                  Privacy Policy
                </Link>
                ...
                <span className="text-[9px] font-bold uppercase tracking-[1.2px] text-[#625C56]">
                  Think · Innovate · Grow
                </span>
              </div>
            </div>
...
function FooterHeading({ title }) {
  return (
    <div className="flex items-center gap-2.5">
      <span className="h-[2px] w-5 rounded-full bg-[#FF6500]" />

      <h3 className="text-[9px] font-bold uppercase tracking-[1.8px] text-white">
        {title}
      </h3>
    </div>
  );
...
function FooterLink({ name, href }) {
  return (
    <Link
      href={href}
      className="group inline-flex items-center gap-1.5 text-[10px] text-[#77716A] transition-colors duration-300 hover:text-white sm:text-[11px]"
    >
      {name}
